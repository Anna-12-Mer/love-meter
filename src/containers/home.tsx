...
const Home: React.FC = () => {
  ...
  return <>
    <Container className='text-center text-base font-normal font-primary'>
    <Row className='justify-center'> <img alt='love-o-meter logo' src={logo} className='!w-24 !m-5'/></Row>
      ...
      <Row  className='justify-center'>Get ready for some giggles and share your results with friends for a dose of joy! Happy surveying! 🎉😄</Row>
